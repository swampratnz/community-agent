...
- `src/module/agent/tools/knowledgeMember.ts` — The member-facing knowledge ToolDef domain: `knowledge_search` (with its turn-state gap/stale correlation writes), `list_knowledge_topics`, `most_helpful_knowledge`, `suggest_knowledge`, `withdraw_knowledge_tip`.
