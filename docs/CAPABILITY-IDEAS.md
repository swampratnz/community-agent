...
precedent. `src/module/media/grokImage.ts` remains unrelated: it generates images as
...
`src/module/platforms/discord/slashCommands.ts` implements the exact four
