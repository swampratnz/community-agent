...
test('registry names are unique, exactly 121 defs, and every def is registered on a built server', () => {
  ...
  // find_knowledge, +1 for issue #1024's list_top_knowledge, +1 for issue
  // #1070's most_helpful_knowledge, +1 for issue #1185's remove_project, +1
  ...
  // set_interest_match_alerts, +1 for issue #1354's rate_connection_outcome.
  // A change here must be a conscious tool addition/removal, never a domain
  // file falling out of the registry.
