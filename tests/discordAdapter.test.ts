...
test(
  'SECURITY: DiscordAdapter.adminCapabilities does not gain block_user/unblock_user (issue #572 acceptance ' +
    "criterion 6) — that's a WhatsApp-only primitive; Discord's existing ban_user already fully covers this",
  () => {
