...
const { PROJECT_NOTE_CONTENT_MAX_CHARS, PROJECT_NOTE_TITLE_MAX_CHARS } =
  await import('@swampratnz/agent-base/storage/repository/projects.js');
...
let repoPromise: Promise<typeof import('@swampratnz/agent-base/storage/repository.js')> | null = null;
function repo(t: TestContext) {
  if (!repoPromise) {
    ...
    repoPromise = import('@swampratnz/agent-base/storage/repository.js');
  }
  return repoPromise;
}

type Repo = typeof import('@swampratnz/agent-base/storage/repository.js');
