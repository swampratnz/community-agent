...
import type { OutgoingMessage, Platform, PlatformAdapter } from '@swampratnz/agent-base/platforms/types.js';
...
const { notifyAccessRequest } = await import('@swampratnz/agent-base/router.js');
