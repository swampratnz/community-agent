 ...
 * share 1:1 with `KnowledgeCitationInfo`. `lowRatedCaveat` is deliberately
 * left `false` (scope guardrail: wiring in `areKnowledgeEntriesLowRated` is
 * the named follow-up, not this PR). The clause is trusted, bot-computed text
