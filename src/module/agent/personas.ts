...
import { allPersonas, registerPersona, type Persona } from '../../base/agent/personaRegistry.js';

export { getPersona, selectPersona, type Persona } from '../../base/agent/personaRegistry.js';
